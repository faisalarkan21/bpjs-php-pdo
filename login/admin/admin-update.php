...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (isset($_POST['submit'])) {
   ...
   try {
    $pdo = Database::connect();
    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $sql = "UPDATE users  set username = ?, nama = ?, nama_level =? , email= ?, bpjs=?,mobile=?,level=? WHERE id = ?";
    $q = $pdo->prepare($sql);
    $q->execute(array($nama,$nama_asli,$nama_level,$email,$bpjs,$hp,$level_id, $id));
        ...
        <div class="content-wrapper">
          ...
          <div class="container">
            ...
            <div class="">
              <div class="row">
                <br/>
                <h3 align="center">Ubah Data User</h3>
                <br/>
              </div>
            ...
            <fieldset>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                  <div class="input-group">
                    ...
                    <input  name="nama" placeholder="First Name" class="form-control" value="<?php echo $data['nama'];?>"  type="text"  required="required">
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                  <div class="input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                    <input  name="username" placeholder="First Name" class="form-control" value="<?php echo $data['username'];?>"  type="text"  required="required">
              ...
              <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                  <div class="input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                    <input  name="email" placeholder="First Name" class="form-control" value="<?php echo $data['email'];?>"  type="text" required="required">
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                  <div class="input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                    <input  name="mobile" placeholder="Last Name" class="form-control" value="<?php echo $data['mobile'];?>" type="text"  required="required">
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                  <div class="input-group">
                    ...
                    $pilih1 =null;
                    $pilih2 =null;
                    $dropdown = $data['nama_level'];

                    if ($dropdown == "Administrator"){

                      $pilih1 ="selected";

                    }elseif ($dropdown == "User") {
                    ...
                    <select class="form-control" name="nama_leveldrop" id="sel1" >
                      <option <?php echo "$pilih1";?>>Administrator</option>
                      <option <?php echo "$pilih2";?>>User</option>                    
                    </select>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                  <div class="input-group">
                    ...
                    <input  name="bpjs" placeholder="(845)555-1212" class="form-control" value="<?php echo $data['bpjs'];?>" type="text"  required="required">
                  </div>
                </div>
              </div>
              ...
              <div class="form-actions col-md-9 col-md-offset-6">
                ...
                <input class="btn btn-success" value="Ubah Data"  type="submit" name="submit" ></input>
