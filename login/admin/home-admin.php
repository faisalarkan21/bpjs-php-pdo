      ...
      <aside class="main-sidebar">
        ...
        <div class="content-wrapper">
          ...
          <div class="container col-md-9 col-md-offset-1" >
            ...
            <div class="row">
              <h1 id align="left">Daftar User Aktif</h3>
              </div>
              <br/>
              ...
              <div class="row ">       
                ...
                <table class="table table-striped table-bordered">
                  ...
                  <tbody>
                    ...
                    foreach ($pdo->query($sql) as $row) {
                      ...
                      echo '<td width=100>';
                      echo '<a class="btn btn-success" href="admin-read.php?id='.$row['id'].'">Lebih Detail</a>';
                ...
                <p>
                <a href="admin-add.php" class="btn btn-success">Tambah User Baru</a>
                </p>
              </div>
            </div>
