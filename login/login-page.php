...
<body>
  ...
  if(isset($_POST['login'])){
    ...
    if(mysqli_num_rows($query) == 0){
     ...
     if($row['level'] == 3 && $level == 3){
      $_SESSION['username']=$username;
      $_SESSION['level']='user';
      header("Location: admin/home-user.php");
    }else{
      echo '<div class="alert alert-danger">Upss...!!! Login gagal.</div>';
    }
...
<div class="module form-module">
  ...
  <div class="form">
    ...
    <form method="post">
     <input type="text" name="nama-asli" placeholder="Nama Anda" required="required"/>
